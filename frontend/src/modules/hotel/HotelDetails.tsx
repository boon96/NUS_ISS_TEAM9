...
export const ManagerView = (props) => {
    ...
    return (
        <div className="roomContainer">
            {/* <Flex> */}
            {/* <img src={require('../../resources/2bed.png').default} alt="Hotel Name" width="60%" height="300" /> */}
                ...
                <div className='details' style={{ width: '40%', marginLeft: '20px' }}>
                    <label className="small">Location: <span>ASD</span></label>
                    <label className="small">Price: <span>123</span></label>
                </div>
            {/* </Flex> */}
